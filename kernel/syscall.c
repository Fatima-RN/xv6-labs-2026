...
// Helper function definition BEFORE syscall()
int
check_path_match(struct proc *p, int num)
{
  if (p->interpose_path[0] == '\0' || (p->interpose_path[0] == '-' && p->interpose_path[1] == '\0'))
    return 0;
